    ...
    return (
        <div className="min-h-screen font-nunito text-white p-4 md:p-8 relative overflow-hidden">
            ...
            <motion.div
                ...
                className="absolute top-1/4 right-1/4 w-[400px] h-[400px] bg-game-secondary/15 blur-[120px] rounded-full pointer-events-none"
            ></motion.div>

            <motion.div
                animate={{ scale: [1.2, 1, 1.2], rotate: [0, 360] }}
                transition={{ repeat: Infinity, duration: 25, ease: "linear" }}
                className="absolute bottom-1/3 left-1/4 w-[500px] h-[500px] bg-game-primary/10 blur-[100px] rounded-full pointer-events-none"
            ></motion.div>
